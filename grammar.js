...
module.exports = grammar({
  ...
  conflicts: ($) => [
    ...
    [$.cobolWord, $.cicsDfhRespLiteral],
    [$.cobolWord, $.cicsDfhValueLiteral],
    [$.procedureDivisionByValuePhrase],
    [$.GOBACK, $.GO],
    [$.paragraph, $.sentence],
    [$.acceptStatement],
    ...
    [$.configurationSection],
    [$.inputOutputSection],
    [$.defaultComputationalSignClause, $.cobolWord],
    [$.defaultDisplaySignClause, $.cobolWord],
    [$.odtClause, $.cobolWord],
    [$.REF, $.REFERENCE],
    [$.subscript],
    ...
    [$.sortCollatingSequencePhrase],
    [$.sortUsing],
    [$.FOR, $.FOREGROUND_COLOR, $.FOREGROUND_COLOUR],
    [$.notOnOverflowPhrase],
    [$.subtractMinuendCorresponding],
    ...
    [$.pictureChars, $.INTEGERLITERAL],
    [$.pictureChars, $.NUMERICLITERAL],
    [$.pictureString],
    [$.dataUsageClause],
    [$.fileDescriptionEntry],
    [$.libraryDescriptionEntryFormat2],
    ...
    [$.reserveClause],
    [$.fileStatusClause],
    [$.SHARED, $.SHAREDBYALL, $.SHAREDBYRUNUNIT],
    [$.THREAD, $.THREAD_LOCAL],
    [$.NULL, $.NULLS],
    [$.ZERO, $.ZEROES],
    [$.ZERO, $.ZEROS],
    ...
    [$.LINE, $.LINES],
    [$.VALUE, $.VALUES],
    [$.collatingSequenceClauseNational, $.cobolWord],
    ...
    [$.NUMERIC, $.NUMERIC_DATE, $.NUMERIC_TIME],
    [$.destinationTableClause],
